...
export function makeAut(type: AutomatonType, opts: AutomatonOpts) {
  switch(type) {
...
export abstract class Automaton {
  ...
  get stateNames(): [string] { return this.opts.stateNames; };
  get finalStates(): [number] { return this.opts.finalStates; };
  get initialStates(): [number] { return this.opts.initialStates; };
